...
with open('/home/zhenmie/Documents/python/datas/top250_f1.csv', 'w', encoding='utf8') as outputfile:
    outputfile.write("num#title#direcor#role#init_year#area#genre#rating_num#comment_num#comment#url\n")
